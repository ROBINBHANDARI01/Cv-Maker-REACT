...
export default function Login() {
  ...
  return (
    <div className="relative overflow-hidden h-screen w-full bg-[url('C:\Users\acer\Documents\codes\web_dev\projects\Cv-Maker-REACT\src\assets\wave_background.svg')] bg-cover bg-center">
      ...
      {/* Card */}
      <div className="relative z-10 flex flex-1 items-center justify-center md:px-4 pb-20 mt-5">
        <div className="w-full max-w-md bg-[rgba(15,30,90,0.55)] border border-white/20 rounded-2xl p-9 shadow-2xl shadow-blue-400/40">
          ...
          <div className="flex flex-col items-center mb-7">
            ...
            <p className="text-sm opacity-80 text-center text-blue-200/80 mt-1 mx-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <input
              ...
              className="w-full placeholder:text-[1rem] pl-10 pr-4 py-2.5 text-xs border text-white border-slate-200 rounded-xl bg-white/10 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 placeholder:text-slate-300 transition-all"
            />
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 placeholder:text-[1rem] text-xs pr-10 py-2.5 text-white border border-slate-200 rounded-xl bg-white/10 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 placeholder:text-slate-300 transition-all"
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex justify-center gap-1 w-full py-3 bg-blue-600 hover:opacity-90 active:scale-[0.98] text-white font-semibold rounded-xl text-sm transition-all disabled:opacity-60 disabled:cursor-not-allowed"
            >
