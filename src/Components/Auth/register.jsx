      ...
      <div className="relative overflow-hidden h-screen w-full bg-[url('C:\Users\acer\Documents\codes\web_dev\projects\Cv-Maker-REACT\src\assets\wave_background.svg')] bg-cover  bg-center">
        ...
        <nav className="relative z-10 flex items-center justify-around md:px-8 py-4">
          <div className="flex items-center gap-1">
            <img src={logo} alt="logo" className="h-6 md:h-8"></img>
            <span className="text-sm hidden sm:block text-white/95 font-medium">
              MakeMyResume
            </span>
          </div>
        ...
        <div className="relative z-10 flex flex-1 items-center justify-center px-4 pb-20 mt-5">
          <div
            className="w-full max-w-md  bg-[rgba(15,30,90,0.55)]  border  border-white/20
          ...
          >
            <div className="flex flex-col items-center mb-7">
              ...
              <p className="text-sm opacity-80 text-center text-blue-200/80 mt-1 mx-10">
               Join thousands of job seekers building their job winning resume.
              </p>
            </div>
